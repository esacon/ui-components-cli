...
import { focusInput, focusRing, hasErrorInput } from "@/constants/components";
...
const isBrowserLocaleClockType24h = () => {
    const language =
        typeof window !== "undefined" ? window.navigator.language : "de-DE";
...
const TimeInput = React.forwardRef<HTMLDivElement, TimeInputProps>(
    ({ hourCycle, ...props }: TimeInputProps, ref) => {
        ...
        const locale =
            window !== undefined ? window.navigator.language : "de-DE";
